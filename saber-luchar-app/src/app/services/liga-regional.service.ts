...
export class LigaRegionalService
{
  private url = 'https://docs.google.com/spreadsheets/d/e/2PACX-1vTLxRgLMgXXCtURQLPP3KbhwdAlT2-64i0gFxm3VEFACOGcToyKGXcl9sCWHBCDrcnhKoH9PV7H5ZnF/pub?gid=813226046&single=true&output=csv';
  ...
  getLuchas(jornada?: number): Observable<Lucha[]>
  {
    return this.http.get(this.url, { responseType: 'text' }).pipe(
      catchError(() => this.http.get('assets/liga-regional.csv', { responseType: 'text' })),
