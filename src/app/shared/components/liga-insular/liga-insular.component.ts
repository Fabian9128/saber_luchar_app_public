...
import { LigaInsularService, Lucha } from '../../../services/liga-insular.service';
...
export class LigaInsularComponent implements OnInit 
{
  ...
  constructor(private ligaService: LigaInsularService) {}
  ...
  {
    this.loading = true;
    this.ligaService.getLuchas().subscribe(
    {
      next: (allLuchas) =>
      {
